...
1. **归类** — 按 [content-taxonomy.md](references/content-taxonomy.md) 把每条信息标类型；冲突处问用户一句。不同表格来源（Notion simple table / database、Markdown 表、CSV 等）的读取与解析方式见 [table-source-handling.md](references/table-source-handling.md)。
